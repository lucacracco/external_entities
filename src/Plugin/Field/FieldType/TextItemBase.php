...
/**
 * Base class for 'text' configurable field types for external entities.
 */
abstract class TextItemBase extends FieldItemBase {
  ...
  public function storageSettingsForm(array &$form, FormStateInterface $form_state, $has_data) {
    ...
    $element['external_field_key'] = [
      '#type' => 'textfield',
      '#title' => t('External Field Key'),
      '#default_value' => $this->getSetting('external_field_key'),
      '#required' => TRUE,
      '#description' => t('The external field key of external entities.'),
    ];
